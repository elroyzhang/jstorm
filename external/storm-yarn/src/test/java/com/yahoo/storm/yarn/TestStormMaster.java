...
public class TestStormMaster {
  ...
  public static void setup() throws InterruptedException, IOException {
    ...
    StormAMRMClient client = new StormAMRMClient(appAttemptId, storm_conf,
        hadoopConf);

    LOG.info("Storm server attaching to port: "
        + storm_conf.get(Config.MASTER_THRIFT_PORT));
    // launch server
    ...
    while (!server.isServing())
      Thread.sleep(10);
    LOG.info("Storm server started at port: "
        + storm_conf.get(Config.MASTER_THRIFT_PORT));
