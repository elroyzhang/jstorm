...
public class AccuracyAggregator<L> implements
		CombinerAggregator<AccuracyState<L>> {
	...
	public AccuracyState<L> init(TridentTuple tuple) {
		...
		boolean equals = this.equals(expected, prediction);
	...
	public AccuracyState<L> combine(AccuracyState<L> val1, AccuracyState<L> val2) {
		return new AccuracyState<L>(val1.totalCount + val2.totalCount,
				val1.errorCount + val2.errorCount);
	}
	...
	public static class AccuracyState<L> implements Evaluation<L> {
		...
		public String toString() {
			return "AccuracyState [totalCount=" + totalCount + ", errorCount="
					+ errorCount + "]";
		}
