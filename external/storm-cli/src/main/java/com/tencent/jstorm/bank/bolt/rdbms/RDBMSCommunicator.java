...
public class RDBMSCommunicator {
  ...
  private String stmt = null, colType = null, values = "", primaryKey = null,
      tableName = null;
  ...
  public void createTable(String tableName, String primaryKey,
      List<String> columnNames, List<String> columnTypes) throws SQLException {
    try {
      prepstmt = null;
      ...
      if (columnNames.size() == columnTypes.size()) {
        ...
        stmt =
            stmt + columnNames.get(noOfColumns - 1) + " "
                + columnTypes.get(noOfColumns - 1);

      } else {
        System.out
            .println("Wrong input : Number of columns doesn't match the number of given data types");
      }
