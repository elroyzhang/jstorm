...
struct SupervisorInfo {
    ...
    9: optional string supervisor_conf;
...
struct Assignment {
    ...
    7: list<ProfileRequest> profile_requests = {};
}
...
struct WorkerJvmInfo {
  1: required string topologyId,
  2: required map<string, map<string, string>> value;
}
...
service Nimbus {
  ...
  **/
  ...
  list<TopologySummary> getTopologySummarys() throws (1: AuthorizationException aze);
  list<NimbusSummary> getNimbusSummarys() throws (1: AuthorizationException aze);
  list<SupervisorSummary> getSupervisorSummarys() throws (1: AuthorizationException aze);
  NimbusSummary getNimbusLeader() throws (1: AuthorizationException aze);
  ...
  list<WorkerJvmInfo> getWorkerJvmInfos(1: string topologyId) throws (1: AuthorizationException aze);
  TopologyBackpressure getTopologyBackpressure(1: string topologyName) throws (1: AuthorizationException aze);
}
...
struct TopologyBackpressure {
  1: required map<string, i32> componentToBackpressure = {};
}