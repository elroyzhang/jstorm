...
rm -rf ../../main/java/org/apache/storm/generated
rm -rf ../../main/py/gen-py
...
mv gen-py/__init__.py.tmp ../../main/py/storm/__init__.py
for file in gen-py/storm/* ; do
  cat py_license_header.txt ${file} > ${file}.tmp
  mv -f ${file}.tmp ${file}
done
mv gen-javabean/org/apache/storm/generated ../../main/java/org/apache/storm/generated
mv gen-py ../../main/py
rm -rf gen-javabean
