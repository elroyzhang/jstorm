            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulseIds = new ArrayList<String>(_list758.size);
                String _elem759;
                for (int _i760 = 0; _i760 < _list758.size; ++_i760)
                {
                  _elem759 = iprot.readString();
                  struct.pulseIds.add(_elem759);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBNodes struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulseIds != null) {
        oprot.writeFieldBegin(PULSE_IDS_FIELD_DESC);
        {
          ...
          for (String _iter761 : struct.pulseIds)
          {
      ...
      if (struct.is_set_pulseIds()) {
        {
          ...
          for (String _iter762 : struct.pulseIds)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulseIds = new ArrayList<String>(_list763.size);
          String _elem764;
          for (int _i765 = 0; _i765 < _list763.size; ++_i765)
          {
            _elem764 = iprot.readString();
            struct.pulseIds.add(_elem764);
          }
        }
        struct.set_pulseIds_isSet(true);
      }
