...
public class LSWorkerHeartbeat implements org.apache.thrift.TBase<LSWorkerHeartbeat, LSWorkerHeartbeat._Fields>, java.io.Serializable, Cloneable, Comparable<LSWorkerHeartbeat> {
  ...
  public void unset_process_id() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PROCESS_ID_ISSET_ID);
  }

  /** Returns true if field process_id is set (has been assigned a value) and false otherwise */
  public boolean is_set_process_id() {
    return EncodingUtils.testBit(__isset_bitfield, __PROCESS_ID_ISSET_ID);
  }

  public void set_process_id_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PROCESS_ID_ISSET_ID, value);
  }
  ...
  public int compareTo(LSWorkerHeartbeat other) {
    ...
    lastComparison = Boolean.valueOf(is_set_process_id()).compareTo(other.is_set_process_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class LSWorkerHeartbeatStandardScheme extends StandardScheme<LSWorkerHeartbeat> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, LSWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // PROCESS_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.process_id = iprot.readI32();
              struct.set_process_id_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.process_id);
      oprot.writeFieldEnd();
