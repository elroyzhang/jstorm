            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list750.size);
                HBPulse _elem751;
                for (int _i752 = 0; _i752 < _list750.size; ++_i752)
                {
                  _elem751 = new HBPulse();
                  _elem751.read(iprot);
                  struct.pulses.add(_elem751);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (HBPulse _iter753 : struct.pulses)
          {
      ...
      if (struct.is_set_pulses()) {
        {
          ...
          for (HBPulse _iter754 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list755.size);
          HBPulse _elem756;
          for (int _i757 = 0; _i757 < _list755.size; ++_i757)
          {
            _elem756 = new HBPulse();
            _elem756.read(iprot);
            struct.pulses.add(_elem756);
          }
        }
        struct.set_pulses_isSet(true);
      }
