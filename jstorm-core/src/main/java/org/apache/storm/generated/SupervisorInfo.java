...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
  ...
  private static final org.apache.thrift.protocol.TField SUPERVISOR_CONF_FIELD_DESC = new org.apache.thrift.protocol.TField("supervisor_conf", org.apache.thrift.protocol.TType.STRING, (short)9);
  ...
  private String supervisor_conf; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SUPERVISOR_CONF((short)9, "supervisor_conf"),
  ...
  private static final _Fields optionals[] = {_Fields.ASSIGNMENT_ID,_Fields.USED_PORTS,_Fields.META,_Fields.SCHEDULER_META,_Fields.UPTIME_SECS,_Fields.VERSION,_Fields.SUPERVISOR_CONF,_Fields.RESOURCES_MAP};
  ...
  static {
    ...
    tmpMap.put(_Fields.VERSION, new org.apache.thrift.meta_data.FieldMetaData("version", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.SUPERVISOR_CONF, new org.apache.thrift.meta_data.FieldMetaData("supervisor_conf", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public SupervisorInfo(SupervisorInfo other) {
    ...
    if (other.is_set_supervisor_conf()) {
      this.supervisor_conf = other.supervisor_conf;
    }
  ...
  public String get_supervisor_conf() {
    return this.supervisor_conf;
  }

  public void set_supervisor_conf(String supervisor_conf) {
    this.supervisor_conf = supervisor_conf;
  }

  public void unset_supervisor_conf() {
    this.supervisor_conf = null;
  }

  /** Returns true if field supervisor_conf is set (has been assigned a value) and false otherwise */
  public boolean is_set_supervisor_conf() {
    return this.supervisor_conf != null;
  }

  public void set_supervisor_conf_isSet(boolean value) {
    if (!value) {
      this.supervisor_conf = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SUPERVISOR_CONF:
      if (value == null) {
        unset_supervisor_conf();
      } else {
        set_supervisor_conf((String)value);
      }
      break;
  ...
  public boolean equals(SupervisorInfo that) {
    ...
    boolean this_present_supervisor_conf = true && this.is_set_supervisor_conf();
    boolean that_present_supervisor_conf = true && that.is_set_supervisor_conf();
    if (this_present_supervisor_conf || that_present_supervisor_conf) {
      if (!(this_present_supervisor_conf && that_present_supervisor_conf))
        return false;
      if (!this.supervisor_conf.equals(that.supervisor_conf))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_supervisor_conf = true && (is_set_supervisor_conf());
    list.add(present_supervisor_conf);
    if (present_supervisor_conf)
      list.add(supervisor_conf);
  ...
  public int compareTo(SupervisorInfo other) {
    ...
    lastComparison = Boolean.valueOf(is_set_supervisor_conf()).compareTo(other.is_set_supervisor_conf());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_supervisor_conf()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.supervisor_conf, other.supervisor_conf);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (is_set_supervisor_conf()) {
      if (!first) sb.append(", ");
      sb.append("supervisor_conf:");
      if (this.supervisor_conf == null) {
        sb.append("null");
      } else {
        sb.append(this.supervisor_conf);
      }
      first = false;
    }
    if (is_set_resources_map()) {
  ...
  private static class SupervisorInfoStandardScheme extends StandardScheme<SupervisorInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 9: // SUPERVISOR_CONF
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.supervisor_conf = iprot.readString();
              struct.set_supervisor_conf_isSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.supervisor_conf != null) {
        if (struct.is_set_supervisor_conf()) {
          oprot.writeFieldBegin(SUPERVISOR_CONF_FIELD_DESC);
          oprot.writeString(struct.supervisor_conf);
          oprot.writeFieldEnd();
        }
      }
