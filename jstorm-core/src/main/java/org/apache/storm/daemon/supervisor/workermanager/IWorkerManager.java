...
public interface IWorkerManager {
    ...
    @ClojureClass(className = "add new method for kill worker paramllism")
    void shutdownWorkers(String supervisorId, List<String> workerIds, Map<String, String> workerThreadPids);
