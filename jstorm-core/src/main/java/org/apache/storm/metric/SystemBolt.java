...
import com.tencent.jstorm.metric.ProcessMemoryUsageMetric;
...
public class SystemBolt implements IBolt {
    ...
    public void prepare(final Map stormConf, TopologyContext context, OutputCollector collector) {
        ...
        // add by JStorm develper,for get process info. http://git.oa.com/trc/jstorm/issues/8
        context.registerMetric(MapKeyConstants.PROCESS_INFO, new ProcessMemoryUsageMetric(jvmRT), bucketSize);
    }
