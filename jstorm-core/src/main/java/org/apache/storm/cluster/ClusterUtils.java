...
public class ClusterUtils {
    ...
    public static final String WORKER_JVM_ROOT = "worker-jvm-info";
    public static final String DRPC_SERVER_ROOT = "drpc-server";
    public static final String LOGVIEWER_ROOT = "logviewer";
    ...
    /**add by jstorm developer -- begin**/
    public static final String USER_SUBTREE = ZK_SEPERATOR + UI_ROOT;
    public static final String UI_SUBTREE = ZK_SEPERATOR + USER_ROOT;
    public static final String WORKER_JVM_SUBTREE = ZK_SEPERATOR + WORKER_JVM_ROOT;
    public static final String DRPC_SERVER_SUBTREE = ZK_SEPERATOR + DRPC_SERVER_ROOT;
    public static final String LOGVIEWER_SUBTREE = ZK_SEPERATOR + LOGVIEWER_ROOT;
    /**add by jstorm developer -- end**/
    ...
    public static String workerJvmInfoPath(String host, Long port) {
      return WORKER_JVM_SUBTREE + ZK_SEPERATOR + host + ":" + port;
    }

    public static String drpcServerPath(String drpcServerId) {
      return DRPC_SERVER_SUBTREE + ZK_SEPERATOR + drpcServerId;
    }

    public static String logviewerPath(String logviewerId) {
      return LOGVIEWER_SUBTREE + ZK_SEPERATOR + logviewerId;
    }
}
