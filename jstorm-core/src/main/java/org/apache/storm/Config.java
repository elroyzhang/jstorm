...
public class Config extends HashMap<String, Object> {
    ...
    /**
     * Whether or not the bolt should update tuple to spout.
     */
    @isBoolean
    public static final String TOPOLOGY_BOLTS_UPDATE_ENABLE = "topology.bolts.update.enable";
    ...
    */
    ...
    /**
     * Wait after add nimbus to zookeeper leader queue, make sure nimbus gain leadership.
     */
    @isInteger
    @ClojureClass(className="in ServiceHandler<init>, make sure we don't skip leader operation like clean corrupt topologies")
    public static final String NIMBUS_GAIN_LEADER_WAIT_SECS = "nimbus.gain.leader.wait.secs";
    ...
    /**
     * path to save topology jar
     */
    @NotNull
    @isString
    public static String TOPOLOGY_JAR_PATH = "topology.jar.path";
    
    /**
     * path to save tdspider jar
     */
    @NotNull
    @isString
    public static String TDSPIDER_JAR_PATH = "tdspider.jar.path";
