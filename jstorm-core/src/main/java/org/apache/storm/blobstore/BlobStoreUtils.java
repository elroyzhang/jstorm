...
public class BlobStoreUtils {
    ...
    @ClojureClass(className="shutdown ClientBlobStore")
    public static boolean downloadMissingBlob(Map conf, BlobStore blobStore, String key, Set<NimbusInfo> nimbusInfos)
        ...
        for (NimbusInfo nimbusInfo : nimbusInfos) {
            ...
            try {
              ...
              if(remoteBlobStore != null){
                remoteBlobStore.shutdown();
              }
            }
        }
  ...
  @ClojureClass(className="shutdown ClientBlobStore")
  public static void createStateInZookeeper(Map conf, String key,
      NimbusInfo nimbusInfo) throws TTransportException {
    ClientBlobStore cb = null;
    try {
      cb = new NimbusBlobStore();
