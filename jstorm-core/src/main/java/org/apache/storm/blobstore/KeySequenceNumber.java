...
public class KeySequenceNumber {
    ...
    @ClojureClass(className="don't create zk client every time, in case there are alot keys while start ServerHandler")
    public synchronized int getKeySequenceNumber(CuratorFramework zkClient, Map conf) {
