...
public abstract interface RunningExecutor {
  public abstract List<Long> get_executor_id();

  public abstract Object render_stats();

  public abstract AtomicBoolean get_backpressure_flag();
  
  public abstract void crendentials_changed(Credentials creds);
