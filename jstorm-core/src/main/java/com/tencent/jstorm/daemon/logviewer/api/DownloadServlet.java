 ...
 */
@ClojureClass(className = "backtype.storm.daemon.logviewer#download")
public class DownloadServlet extends LogviewerServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      LogViewerUtils.downloadLogFile(file, req, resp, user, logRoot);
    } catch (Exception e) {
