...
public class SpoutExpiredCallback<K, V>
    implements RotatingMap.ExpiredCallback<K, V> {
  ...
  public void expire(K key, V val) {
    ...
    FailSpoutMsg fsm = new FailSpoutMsg(executorData, taskDatas.get(taskId),
        spoutId, tupleInfo, timeDelta, "TIMEOUT", id);
    fsm.run();
  }
}
