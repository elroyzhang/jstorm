...
import com.tencent.jstorm.utils.ServletUtil;

public class LogLevel {
  public static final String USAGES = "\nUSAGES:\n" + "java "
      + LogLevel.class.getName() + " -getlevel <host:port> <name>\n" + "java "
      + LogLevel.class.getName() + " -setlevel <host:port> <name> <level>\n";
  ...
  public static void main(String[] args) {
    if (args.length == 3 && "-getlevel".equals(args[0])) {
      ...
      process("http://" + args[1] + "/logLevel?log=" + args[2] + "&level="
          + args[3]);
      return;
    }
  ...
  public static class Servlet extends HttpServlet {
    ...
    private static void process(org.apache.log4j.Logger log, String level,
      ...
      out.println(MARKER + "Effective level: <b>" + log.getEffectiveLevel()
          + "</b><br />");
    }
