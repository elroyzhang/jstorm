...
public enum StatsFields {
  ...
  emitted(0), transferred(0), acked(3), failed(3), complete_latencies(
      2), complete_latencies_total(2), process_latencies(
          1), process_latencies_total(1), executed(1), execute_latencies(
              1), execute_latencies_total(1);
