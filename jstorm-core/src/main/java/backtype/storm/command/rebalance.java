...
public class rebalance {
  ...
  @Option(name = "--num-workers", aliases = {
      "-n" }, usage = "num of workers default is 0 ")
  private int _numWorkers = 0;

  @Option(name = "--executor", aliases = {
      "-e" }, usage = "num of executors ,usage: -e split=10,count=20  ")
  private String _executor = null;

  private static void printUsage() {
    System.out.println("Usage:");
    System.out.println(
        "    $STORM_HOME/bin/storm rebalance --name topoloygname -w waitsecs -n num_workers -e componedname=num_tasks,componedname2=num_tasks2");
  }
  ...
  public void realMain(String[] args) throws Exception {
    ...
    try {
      CoreUtil.rebalanceTopology(_name, _wait, _numWorkers, _executor);
    } catch (Exception e) {
