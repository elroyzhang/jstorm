...
class Iface:
  ...
  def getTopologySummarys(self):
    pass

  def getNimbusSummarys(self):
    pass

  def getSupervisorSummarys(self):
    pass

  def getNimbusLeader(self):
    pass
  ...
  def getWorkerJvmInfos(self, topologyId):
    """
    Parameters:
     - topologyId
    """
  ...
  def getTopologyBackpressure(self, topologyName):
    """
    Parameters:
     - topologyName
    """
...
class Client(Iface):
  ...
  def getTopologySummarys(self):
    self.send_getTopologySummarys()
    return self.recv_getTopologySummarys()

  def send_getTopologySummarys(self):
    self._oprot.writeMessageBegin('getTopologySummarys', TMessageType.CALL, self._seqid)
    args = getTopologySummarys_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getTopologySummarys(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getTopologySummarys_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.aze is not None:
      raise result.aze
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getTopologySummarys failed: unknown result")

  def getNimbusSummarys(self):
    self.send_getNimbusSummarys()
    return self.recv_getNimbusSummarys()

  def send_getNimbusSummarys(self):
    self._oprot.writeMessageBegin('getNimbusSummarys', TMessageType.CALL, self._seqid)
    args = getNimbusSummarys_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getNimbusSummarys(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getNimbusSummarys_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.aze is not None:
      raise result.aze
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getNimbusSummarys failed: unknown result")

  def getSupervisorSummarys(self):
    self.send_getSupervisorSummarys()
    return self.recv_getSupervisorSummarys()

  def send_getSupervisorSummarys(self):
    self._oprot.writeMessageBegin('getSupervisorSummarys', TMessageType.CALL, self._seqid)
    args = getSupervisorSummarys_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getSupervisorSummarys(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getSupervisorSummarys_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.aze is not None:
      raise result.aze
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getSupervisorSummarys failed: unknown result")

  def getNimbusLeader(self):
    self.send_getNimbusLeader()
    return self.recv_getNimbusLeader()

  def send_getNimbusLeader(self):
    self._oprot.writeMessageBegin('getNimbusLeader', TMessageType.CALL, self._seqid)
    args = getNimbusLeader_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getNimbusLeader(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
    ...
    if result.aze is not None:
      raise result.aze
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getNimbusLeader failed: unknown result")
  ...
  def getWorkerJvmInfos(self, topologyId):
    ...
    Parameters:
     - topologyId
    """
    self.send_getWorkerJvmInfos(topologyId)
    return self.recv_getWorkerJvmInfos()

  def send_getWorkerJvmInfos(self, topologyId):
    self._oprot.writeMessageBegin('getWorkerJvmInfos', TMessageType.CALL, self._seqid)
    args = getWorkerJvmInfos_args()
    args.topologyId = topologyId
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getWorkerJvmInfos(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getWorkerJvmInfos_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.aze is not None:
      raise result.aze
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getWorkerJvmInfos failed: unknown result")
  ...
  def getTopologyBackpressure(self, topologyName):
    ...
    Parameters:
     - topologyName
    """
    self.send_getTopologyBackpressure(topologyName)
    return self.recv_getTopologyBackpressure()

  def send_getTopologyBackpressure(self, topologyName):
    self._oprot.writeMessageBegin('getTopologyBackpressure', TMessageType.CALL, self._seqid)
    args = getTopologyBackpressure_args()
    args.topologyName = topologyName
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getTopologyBackpressure(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = getTopologyBackpressure_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.aze is not None:
      raise result.aze
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getTopologyBackpressure failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getTopologySummarys"] = Processor.process_getTopologySummarys
    self._processMap["getNimbusSummarys"] = Processor.process_getNimbusSummarys
    self._processMap["getSupervisorSummarys"] = Processor.process_getSupervisorSummarys
    self._processMap["getNimbusLeader"] = Processor.process_getNimbusLeader
    ...
    self._processMap["getWorkerJvmInfos"] = Processor.process_getWorkerJvmInfos
    self._processMap["getTopologyBackpressure"] = Processor.process_getTopologyBackpressure
  ...
  def process_getTopologySummarys(self, seqid, iprot, oprot):
    args = getTopologySummarys_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getTopologySummarys_result()
    try:
      result.success = self._handler.getTopologySummarys()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except AuthorizationException as aze:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getTopologySummarys", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getNimbusSummarys(self, seqid, iprot, oprot):
    args = getNimbusSummarys_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getNimbusSummarys_result()
    try:
      result.success = self._handler.getNimbusSummarys()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except AuthorizationException as aze:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getNimbusSummarys", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getSupervisorSummarys(self, seqid, iprot, oprot):
    args = getSupervisorSummarys_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getSupervisorSummarys_result()
    try:
      result.success = self._handler.getSupervisorSummarys()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except AuthorizationException as aze:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getSupervisorSummarys", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getNimbusLeader(self, seqid, iprot, oprot):
    args = getNimbusLeader_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getNimbusLeader_result()
    try:
      result.success = self._handler.getNimbusLeader()
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except AuthorizationException as aze:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getNimbusLeader", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_getWorkerJvmInfos(self, seqid, iprot, oprot):
    args = getWorkerJvmInfos_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getWorkerJvmInfos_result()
    try:
      result.success = self._handler.getWorkerJvmInfos(args.topologyId)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except AuthorizationException as aze:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getWorkerJvmInfos", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_getTopologyBackpressure(self, seqid, iprot, oprot):
    args = getTopologyBackpressure_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getTopologyBackpressure_result()
    try:
      result.success = self._handler.getTopologyBackpressure(args.topologyName)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except AuthorizationException as aze:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("getTopologyBackpressure", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class getTopologySummarys_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getTopologySummarys_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getTopologySummarys_result:
  """
  Attributes:
   - success
   - aze
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(TopologySummary, TopologySummary.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'aze', (AuthorizationException, AuthorizationException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getTopologySummarys_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class getNimbusSummarys_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getNimbusSummarys_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getNimbusSummarys_result:
  """
  Attributes:
   - success
   - aze
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(NimbusSummary, NimbusSummary.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'aze', (AuthorizationException, AuthorizationException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getNimbusSummarys_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class getSupervisorSummarys_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getSupervisorSummarys_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getSupervisorSummarys_result:
  """
  Attributes:
   - success
   - aze
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(SupervisorSummary, SupervisorSummary.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'aze', (AuthorizationException, AuthorizationException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getSupervisorSummarys_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class getNimbusLeader_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getNimbusLeader_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getNimbusLeader_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getNimbusLeader_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
...
class getWorkerJvmInfos_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getWorkerJvmInfos_args')
...
class getWorkerJvmInfos_result:
  """
  Attributes:
   - success
   - aze
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(WorkerJvmInfo, WorkerJvmInfo.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'aze', (AuthorizationException, AuthorizationException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getWorkerJvmInfos_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class getTopologyBackpressure_args:
  """
  Attributes:
   - topologyName
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getTopologyBackpressure_args')
...
class getTopologyBackpressure_result:
  """
  Attributes:
   - success
   - aze
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TopologyBackpressure, TopologyBackpressure.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'aze', (AuthorizationException, AuthorizationException.thrift_spec), None, ), # 1
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = TopologyBackpressure()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 1:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getTopologyBackpressure_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
