...
class JavaObject:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'args_list', (TType.STRUCT,(JavaObjectArg, JavaObjectArg.thrift_spec)), [
    ], ), # 2
  )

  def __init__(self, full_class_name=None, args_list=thrift_spec[2][4],):
    self.full_class_name = full_class_name
    if args_list is self.thrift_spec[2][4]:
      args_list = [
    ]
...
class StreamInfo:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'output_fields', (TType.STRING,None), [
    ], ), # 1
    (2, TType.BOOL, 'direct', None, None, ), # 2
  )

  def __init__(self, output_fields=thrift_spec[1][4], direct=None,):
    if output_fields is self.thrift_spec[1][4]:
      output_fields = [
    ]
...
class ComponentCommon:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'inputs', (TType.STRUCT,(GlobalStreamId, GlobalStreamId.thrift_spec),TType.STRUCT,(Grouping, Grouping.thrift_spec)), {
    }, ), # 1
    (2, TType.MAP, 'streams', (TType.STRING,None,TType.STRUCT,(StreamInfo, StreamInfo.thrift_spec)), {
    }, ), # 2
    (3, TType.I32, 'parallelism_hint', None, None, ), # 3
    (4, TType.STRING, 'json_conf', None, None, ), # 4
  )

  def __init__(self, inputs=thrift_spec[1][4], streams=thrift_spec[2][4], parallelism_hint=None, json_conf=None,):
    if inputs is self.thrift_spec[1][4]:
      inputs = {
    }
    self.inputs = inputs
    if streams is self.thrift_spec[2][4]:
      streams = {
    }
...
class StormTopology:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'spouts', (TType.STRING,None,TType.STRUCT,(SpoutSpec, SpoutSpec.thrift_spec)), {
    }, ), # 1
    (2, TType.MAP, 'bolts', (TType.STRING,None,TType.STRUCT,(Bolt, Bolt.thrift_spec)), {
    }, ), # 2
    (3, TType.MAP, 'state_spouts', (TType.STRING,None,TType.STRUCT,(StateSpoutSpec, StateSpoutSpec.thrift_spec)), {
    }, ), # 3
    (4, TType.LIST, 'worker_hooks', (TType.STRING,None), [
    ], ), # 4
  )

  def __init__(self, spouts=thrift_spec[1][4], bolts=thrift_spec[2][4], state_spouts=thrift_spec[3][4], worker_hooks=thrift_spec[4][4],):
    if spouts is self.thrift_spec[1][4]:
      spouts = {
    }
    self.spouts = spouts
    if bolts is self.thrift_spec[2][4]:
      bolts = {
    }
    self.bolts = bolts
    if state_spouts is self.thrift_spec[3][4]:
      state_spouts = {
    }
    self.state_spouts = state_spouts
    if worker_hooks is self.thrift_spec[4][4]:
      worker_hooks = [
    ]
...
class SupervisorSummary:
  ...
  thrift_spec = (
    ...
    (7, TType.MAP, 'total_resources', (TType.STRING,None,TType.DOUBLE,None), {
    }, ), # 7
    (8, TType.DOUBLE, 'used_mem', None, None, ), # 8
    (9, TType.DOUBLE, 'used_cpu', None, None, ), # 9
  )

  def __init__(self, host=None, uptime_secs=None, num_workers=None, num_used_workers=None, supervisor_id=None, version=thrift_spec[6][4], total_resources=thrift_spec[7][4], used_mem=None, used_cpu=None,):
    self.host = host
    self.uptime_secs = uptime_secs
    self.num_workers = num_workers
    ...
    if total_resources is self.thrift_spec[7][4]:
      total_resources = {
    }
...
class ClusterSummary:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'supervisors', (TType.STRUCT,(SupervisorSummary, SupervisorSummary.thrift_spec)), [
    ], ), # 1
  ...
  def __init__(self, supervisors=thrift_spec[1][4], nimbus_uptime_secs=thrift_spec[2][4], topologies=None, nimbuses=None,):
    if supervisors is self.thrift_spec[1][4]:
      supervisors = [
    ]
...
class BoltStats:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'acked', (TType.STRING,None,TType.MAP,(TType.STRUCT,(GlobalStreamId, GlobalStreamId.thrift_spec),TType.I64,None)), {
    }, ), # 1
    (2, TType.MAP, 'failed', (TType.STRING,None,TType.MAP,(TType.STRUCT,(GlobalStreamId, GlobalStreamId.thrift_spec),TType.I64,None)), {
    }, ), # 2
    (3, TType.MAP, 'process_ms_avg', (TType.STRING,None,TType.MAP,(TType.STRUCT,(GlobalStreamId, GlobalStreamId.thrift_spec),TType.DOUBLE,None)), {
    }, ), # 3
    (4, TType.MAP, 'executed', (TType.STRING,None,TType.MAP,(TType.STRUCT,(GlobalStreamId, GlobalStreamId.thrift_spec),TType.I64,None)), {
    }, ), # 4
    (5, TType.MAP, 'execute_ms_avg', (TType.STRING,None,TType.MAP,(TType.STRUCT,(GlobalStreamId, GlobalStreamId.thrift_spec),TType.DOUBLE,None)), {
    }, ), # 5
  )

  def __init__(self, acked=thrift_spec[1][4], failed=thrift_spec[2][4], process_ms_avg=thrift_spec[3][4], executed=thrift_spec[4][4], execute_ms_avg=thrift_spec[5][4],):
    if acked is self.thrift_spec[1][4]:
      acked = {
    }
    self.acked = acked
    if failed is self.thrift_spec[2][4]:
      failed = {
    }
    self.failed = failed
    if process_ms_avg is self.thrift_spec[3][4]:
      process_ms_avg = {
    }
    self.process_ms_avg = process_ms_avg
    if executed is self.thrift_spec[4][4]:
      executed = {
    }
    self.executed = executed
    if execute_ms_avg is self.thrift_spec[5][4]:
      execute_ms_avg = {
    }
...
class SpoutStats:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'acked', (TType.STRING,None,TType.MAP,(TType.STRING,None,TType.I64,None)), {
    }, ), # 1
    (2, TType.MAP, 'failed', (TType.STRING,None,TType.MAP,(TType.STRING,None,TType.I64,None)), {
    }, ), # 2
    (3, TType.MAP, 'complete_ms_avg', (TType.STRING,None,TType.MAP,(TType.STRING,None,TType.DOUBLE,None)), {
    }, ), # 3
  )

  def __init__(self, acked=thrift_spec[1][4], failed=thrift_spec[2][4], complete_ms_avg=thrift_spec[3][4],):
    if acked is self.thrift_spec[1][4]:
      acked = {
    }
    self.acked = acked
    ...
    self.failed = failed
    if complete_ms_avg is self.thrift_spec[3][4]:
      complete_ms_avg = {
    }
...
class ExecutorStats:
  ...
  def __init__(self, emitted=thrift_spec[1][4], transferred=thrift_spec[2][4], specific=None, rate=None,):
    if emitted is self.thrift_spec[1][4]:
      emitted = {
    }
    self.emitted = emitted
    if transferred is self.thrift_spec[2][4]:
      transferred = {
    }
...
class TopologyInfo:
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'name', None, None, ), # 2
    (3, TType.I32, 'uptime_secs', None, None, ), # 3
    (4, TType.LIST, 'executors', (TType.STRUCT,(ExecutorSummary, ExecutorSummary.thrift_spec)), [
    ], ), # 4
    (5, TType.STRING, 'status', None, None, ), # 5
    (6, TType.MAP, 'errors', (TType.STRING,None,TType.LIST,(TType.STRUCT,(ErrorInfo, ErrorInfo.thrift_spec))), {
    }, ), # 6
    (7, TType.MAP, 'component_debug', (TType.STRING,None,TType.STRUCT,(DebugOptions, DebugOptions.thrift_spec)), {
    }, ), # 7
    None, # 8
    None, # 9
    None, # 10
  ...
  def __init__(self, id=None, name=None, uptime_secs=None, executors=thrift_spec[4][4], status=None, errors=thrift_spec[6][4], component_debug=thrift_spec[7][4], sched_status=None, owner=None, replication_count=None, requested_memonheap=None, requested_memoffheap=None, requested_cpu=None, assigned_memonheap=None, assigned_memoffheap=None, assigned_cpu=None,):
    self.id = id
    self.name = name
    self.uptime_secs = uptime_secs
    if executors is self.thrift_spec[4][4]:
      executors = [
    ]
    self.executors = executors
    self.status = status
    if errors is self.thrift_spec[6][4]:
      errors = {
    }
    self.errors = errors
    if component_debug is self.thrift_spec[7][4]:
      component_debug = {
    }
...
class TopologyStats:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'window_to_emitted', (TType.STRING,None,TType.I64,None), {
    }, ), # 1
    (2, TType.MAP, 'window_to_transferred', (TType.STRING,None,TType.I64,None), {
    }, ), # 2
    (3, TType.MAP, 'window_to_complete_latencies_ms', (TType.STRING,None,TType.DOUBLE,None), {
    }, ), # 3
    (4, TType.MAP, 'window_to_acked', (TType.STRING,None,TType.I64,None), {
    }, ), # 4
    (5, TType.MAP, 'window_to_failed', (TType.STRING,None,TType.I64,None), {
    }, ), # 5
  )

  def __init__(self, window_to_emitted=thrift_spec[1][4], window_to_transferred=thrift_spec[2][4], window_to_complete_latencies_ms=thrift_spec[3][4], window_to_acked=thrift_spec[4][4], window_to_failed=thrift_spec[5][4],):
    if window_to_emitted is self.thrift_spec[1][4]:
      window_to_emitted = {
    }
    self.window_to_emitted = window_to_emitted
    if window_to_transferred is self.thrift_spec[2][4]:
      window_to_transferred = {
    }
    self.window_to_transferred = window_to_transferred
    if window_to_complete_latencies_ms is self.thrift_spec[3][4]:
      window_to_complete_latencies_ms = {
    }
    self.window_to_complete_latencies_ms = window_to_complete_latencies_ms
    if window_to_acked is self.thrift_spec[4][4]:
      window_to_acked = {
    }
    self.window_to_acked = window_to_acked
    if window_to_failed is self.thrift_spec[5][4]:
      window_to_failed = {
    }
...
class TopologyPageInfo:
  ...
  thrift_spec = (
    ...
    (9, TType.MAP, 'id_to_spout_agg_stats', (TType.STRING,None,TType.STRUCT,(ComponentAggregateStats, ComponentAggregateStats.thrift_spec)), {
    }, ), # 9
    (10, TType.MAP, 'id_to_bolt_agg_stats', (TType.STRING,None,TType.STRUCT,(ComponentAggregateStats, ComponentAggregateStats.thrift_spec)), {
    }, ), # 10
  ...
  def __init__(self, id=None, name=None, uptime_secs=None, status=None, num_tasks=None, num_workers=None, num_executors=None, topology_conf=None, id_to_spout_agg_stats=thrift_spec[9][4], id_to_bolt_agg_stats=thrift_spec[10][4], sched_status=None, topology_stats=None, owner=None, debug_options=None, replication_count=None, requested_memonheap=None, requested_memoffheap=None, requested_cpu=None, assigned_memonheap=None, assigned_memoffheap=None, assigned_cpu=None,):
    self.id = id
    self.name = name
    self.uptime_secs = uptime_secs
    self.status = status
    ...
    if id_to_spout_agg_stats is self.thrift_spec[9][4]:
      id_to_spout_agg_stats = {
    }
    self.id_to_spout_agg_stats = id_to_spout_agg_stats
    if id_to_bolt_agg_stats is self.thrift_spec[10][4]:
      id_to_bolt_agg_stats = {
    }
...
class ComponentPageInfo:
  ...
  thrift_spec = (
    ...
    (7, TType.MAP, 'window_to_stats', (TType.STRING,None,TType.STRUCT,(ComponentAggregateStats, ComponentAggregateStats.thrift_spec)), {
    }, ), # 7
    (8, TType.MAP, 'gsid_to_input_stats', (TType.STRUCT,(GlobalStreamId, GlobalStreamId.thrift_spec),TType.STRUCT,(ComponentAggregateStats, ComponentAggregateStats.thrift_spec)), {
    }, ), # 8
    (9, TType.MAP, 'sid_to_output_stats', (TType.STRING,None,TType.STRUCT,(ComponentAggregateStats, ComponentAggregateStats.thrift_spec)), {
    }, ), # 9
    (10, TType.LIST, 'exec_stats', (TType.STRUCT,(ExecutorAggregateStats, ExecutorAggregateStats.thrift_spec)), [
    ], ), # 10
    (11, TType.LIST, 'errors', (TType.STRUCT,(ErrorInfo, ErrorInfo.thrift_spec)), [
    ], ), # 11
  ...
  def __init__(self, component_id=None, component_type=None, topology_id=None, topology_name=None, num_executors=None, num_tasks=None, window_to_stats=thrift_spec[7][4], gsid_to_input_stats=thrift_spec[8][4], sid_to_output_stats=thrift_spec[9][4], exec_stats=thrift_spec[10][4], errors=thrift_spec[11][4], eventlog_host=None, eventlog_port=None, debug_options=None, topology_status=None,):
    self.component_id = component_id
    ...
    self.num_executors = num_executors
    self.num_tasks = num_tasks
    if window_to_stats is self.thrift_spec[7][4]:
      window_to_stats = {
    }
    self.window_to_stats = window_to_stats
    if gsid_to_input_stats is self.thrift_spec[8][4]:
      gsid_to_input_stats = {
    }
    self.gsid_to_input_stats = gsid_to_input_stats
    if sid_to_output_stats is self.thrift_spec[9][4]:
      sid_to_output_stats = {
    }
    self.sid_to_output_stats = sid_to_output_stats
    if exec_stats is self.thrift_spec[10][4]:
      exec_stats = [
    ]
    self.exec_stats = exec_stats
    if errors is self.thrift_spec[11][4]:
      errors = [
    ]
    self.errors = errors
...
class RebalanceOptions:
  ...
  thrift_spec = (
    ...
    (3, TType.MAP, 'num_executors', (TType.STRING,None,TType.I32,None), {
    }, ), # 3
  )

  def __init__(self, wait_secs=None, num_workers=None, num_executors=thrift_spec[3][4],):
    self.wait_secs = wait_secs
    self.num_workers = num_workers
    if num_executors is self.thrift_spec[3][4]:
      num_executors = {
    }
    self.num_executors = num_executors
...
class Credentials:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'creds', (TType.STRING,None,TType.STRING,None), {
    }, ), # 1
  )

  def __init__(self, creds=thrift_spec[1][4],):
    if creds is self.thrift_spec[1][4]:
      creds = {
    }
    self.creds = creds
...
class SettableBlobMeta:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'acl', (TType.STRUCT,(AccessControl, AccessControl.thrift_spec)), [
    ], ), # 1
    (2, TType.I32, 'replication_factor', None, None, ), # 2
  )

  def __init__(self, acl=thrift_spec[1][4], replication_factor=None,):
    if acl is self.thrift_spec[1][4]:
      acl = [
    ]
    self.acl = acl
...
class ListBlobsResult:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'keys', (TType.STRING,None), [
    ], ), # 1
    (2, TType.STRING, 'session', None, None, ), # 2
  )

  def __init__(self, keys=thrift_spec[1][4], session=None,):
    if keys is self.thrift_spec[1][4]:
      keys = [
    ]
    self.keys = keys
...
class SupervisorInfo:
  ...
  thrift_spec = (
    ...
    (4, TType.LIST, 'used_ports', (TType.I64,None), [
    ], ), # 4
    (5, TType.LIST, 'meta', (TType.I64,None), [
    ], ), # 5
    ...
    (9, TType.STRING, 'supervisor_conf', None, None, ), # 9
    (10, TType.MAP, 'resources_map', (TType.STRING,None,TType.DOUBLE,None), {
    }, ), # 10
  )

  def __init__(self, time_secs=None, hostname=None, assignment_id=None, used_ports=thrift_spec[4][4], meta=thrift_spec[5][4], scheduler_meta=thrift_spec[6][4], uptime_secs=None, version=None, supervisor_conf=None, resources_map=thrift_spec[10][4],):
    ...
    if resources_map is self.thrift_spec[10][4]:
      resources_map = {
    }
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.supervisor_conf = iprot.readString().decode('utf-8')
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.supervisor_conf is not None:
      oprot.writeFieldBegin('supervisor_conf', TType.STRING, 9)
      oprot.writeString(self.supervisor_conf.encode('utf-8'))
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.uptime_secs)
    value = (value * 31) ^ hash(self.version)
    value = (value * 31) ^ hash(self.supervisor_conf)
...
class Assignment:
  ...
  thrift_spec = (
    ...
    (7, TType.LIST, 'profile_requests', (TType.STRUCT,(ProfileRequest, ProfileRequest.thrift_spec)), [
    ], ), # 7
  )

  def __init__(self, master_code_dir=None, node_host=thrift_spec[2][4], executor_node_port=thrift_spec[3][4], executor_start_time_secs=thrift_spec[4][4], worker_resources=thrift_spec[5][4], version=None, profile_requests=thrift_spec[7][4],):
    ...
    self.version = version
    if profile_requests is self.thrift_spec[7][4]:
      profile_requests = [
    ]
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i534 in xrange(_size530):
            _elem535 = ProfileRequest()
            _elem535.read(iprot)
            self.profile_requests.append(_elem535)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.version is not None:
      ...
      oprot.writeFieldEnd()
    if self.profile_requests is not None:
      oprot.writeFieldBegin('profile_requests', TType.LIST, 7)
      oprot.writeListBegin(TType.STRUCT, len(self.profile_requests))
      for iter546 in self.profile_requests:
        iter546.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.version)
    value = (value * 31) ^ hash(self.profile_requests)
    return value
...
class StormBase:
  ...
  thrift_spec = (
    ...
    (9, TType.MAP, 'component_debug', (TType.STRING,None,TType.STRUCT,(DebugOptions, DebugOptions.thrift_spec)), {
    }, ), # 9
  )

  def __init__(self, name=None, status=None, num_workers=None, component_executors=thrift_spec[4][4], launch_time_secs=None, owner=None, topology_action_options=None, prev_status=None, component_debug=thrift_spec[9][4],):
    self.name = name
    self.status = status
    self.num_workers = num_workers
    if component_executors is self.thrift_spec[4][4]:
      component_executors = {
    }
    ...
    if component_debug is self.thrift_spec[9][4]:
      component_debug = {
    }
    self.component_debug = component_debug
...
class ClusterWorkerHeartbeat:
  ...
  thrift_spec = (
    ...
    (2, TType.MAP, 'executor_stats', (TType.STRUCT,(ExecutorInfo, ExecutorInfo.thrift_spec),TType.STRUCT,(ExecutorStats, ExecutorStats.thrift_spec)), {
    }, ), # 2
    (3, TType.I32, 'time_secs', None, None, ), # 3
    (4, TType.I32, 'uptime_secs', None, None, ), # 4
  )

  def __init__(self, storm_id=None, executor_stats=thrift_spec[2][4], time_secs=None, uptime_secs=None,):
    self.storm_id = storm_id
    if executor_stats is self.thrift_spec[2][4]:
      executor_stats = {
    }
...
class LocalStateData:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'serialized_parts', (TType.STRING,None,TType.STRUCT,(ThriftSerializedObject, ThriftSerializedObject.thrift_spec)), {
    }, ), # 1
  )

  def __init__(self, serialized_parts=thrift_spec[1][4],):
    if serialized_parts is self.thrift_spec[1][4]:
      serialized_parts = {
    }
...
class LocalAssignment:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'executors', (TType.STRUCT,(ExecutorInfo, ExecutorInfo.thrift_spec)), [
    ], ), # 2
    (3, TType.STRUCT, 'resources', (WorkerResources, WorkerResources.thrift_spec), None, ), # 3
  )

  def __init__(self, topology_id=None, executors=thrift_spec[2][4], resources=None,):
    self.topology_id = topology_id
    if executors is self.thrift_spec[2][4]:
      executors = [
    ]
    self.executors = executors
...
class LSSupervisorAssignments:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'assignments', (TType.I32,None,TType.STRUCT,(LocalAssignment, LocalAssignment.thrift_spec)), {
    }, ), # 1
  )

  def __init__(self, assignments=thrift_spec[1][4],):
    if assignments is self.thrift_spec[1][4]:
      assignments = {
    }
...
class LSWorkerHeartbeat:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'executors', (TType.STRUCT,(ExecutorInfo, ExecutorInfo.thrift_spec)), [
    ], ), # 3
    (4, TType.I32, 'port', None, None, ), # 4
    (5, TType.I32, 'process_id', None, None, ), # 5
  )

  def __init__(self, time_secs=None, topology_id=None, executors=thrift_spec[3][4], port=None, process_id=None,):
    self.time_secs = time_secs
    self.topology_id = topology_id
    if executors is self.thrift_spec[3][4]:
      executors = [
    ]
    self.executors = executors
    self.port = port
  ...
  def write(self, oprot):
    ...
    if self.process_id is not None:
      oprot.writeFieldBegin('process_id', TType.I32, 5)
  ...
  def validate(self):
    ...
    if self.process_id is None:
      raise TProtocol.TProtocolException(message='Required field process_id is unset!')
    return
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.executors)
    value = (value * 31) ^ hash(self.port)
    value = (value * 31) ^ hash(self.process_id)
    return value
...
class LSTopoHistory:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'users', (TType.STRING,None), [
    ], ), # 3
    (4, TType.LIST, 'groups', (TType.STRING,None), [
    ], ), # 4
  )

  def __init__(self, topology_id=None, time_stamp=None, users=thrift_spec[3][4], groups=thrift_spec[4][4],):
    self.topology_id = topology_id
    self.time_stamp = time_stamp
    if users is self.thrift_spec[3][4]:
      users = [
    ]
    self.users = users
    if groups is self.thrift_spec[4][4]:
      groups = [
    ]
    self.groups = groups
...
class LSTopoHistoryList:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'topo_history', (TType.STRUCT,(LSTopoHistory, LSTopoHistory.thrift_spec)), [
    ], ), # 1
  )

  def __init__(self, topo_history=thrift_spec[1][4],):
    if topo_history is self.thrift_spec[1][4]:
      topo_history = [
    ]
...
class WorkerJvmInfo:
  ...
  thrift_spec = (
    ...
    (2, TType.MAP, 'value', (TType.STRING,None,TType.MAP,(TType.STRING,None,TType.STRING,None)), None, ), # 2
  )

  def __init__(self, topologyId=None, value=None,):
        ...
        if ftype == TType.MAP:
          ...
          for _i640 in xrange(_size636):
            ...
            for _i647 in xrange(_size643):
              ...
              _val649 = iprot.readString().decode('utf-8')
              _val642[_key648] = _val649
            iprot.readMapEnd()
            self.value[_key641] = _val642
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('WorkerJvmInfo')
    ...
    if self.value is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.MAP, len(self.value))
      for kiter650,viter651 in self.value.items():
        oprot.writeString(kiter650.encode('utf-8'))
        oprot.writeMapBegin(TType.STRING, TType.STRING, len(viter651))
        for kiter652,viter653 in viter651.items():
          oprot.writeString(kiter652.encode('utf-8'))
          oprot.writeString(viter653.encode('utf-8'))
        oprot.writeMapEnd()
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class LogConfig:
  ...
  thrift_spec = (
    None, # 0
    None, # 1
    (2, TType.MAP, 'named_logger_level', (TType.STRING,None,TType.STRUCT,(LogLevel, LogLevel.thrift_spec)), {
    }, ), # 2
  )

  def __init__(self, named_logger_level=thrift_spec[2][4],):
    if named_logger_level is self.thrift_spec[2][4]:
      named_logger_level = {
    }
      ...
      if fid == 2:
        if ftype == TType.MAP:
          ...
          for _i658 in xrange(_size654):
            ...
            _val660 = LogLevel()
            _val660.read(iprot)
            self.named_logger_level[_key659] = _val660
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.named_logger_level is not None:
      ...
      for kiter661,viter662 in self.named_logger_level.items():
...
class TopologyHistoryInfo:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'topo_ids', (TType.STRING,None), [
    ], ), # 1
  )

  def __init__(self, topo_ids=thrift_spec[1][4],):
    if topo_ids is self.thrift_spec[1][4]:
      topo_ids = [
    ]
  ...
  def write(self, oprot):
    ...
    if self.topo_ids is not None:
      ...
      for iter669 in self.topo_ids:
        oprot.writeString(iter669.encode('utf-8'))
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class HBRecords:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'pulses', (TType.STRUCT,(HBPulse, HBPulse.thrift_spec)), [
    ], ), # 1
  )

  def __init__(self, pulses=thrift_spec[1][4],):
    if pulses is self.thrift_spec[1][4]:
      pulses = [
    ]
    self.pulses = pulses
...
class HBNodes:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'pulseIds', (TType.STRING,None), [
    ], ), # 1
  )

  def __init__(self, pulseIds=thrift_spec[1][4],):
    if pulseIds is self.thrift_spec[1][4]:
      pulseIds = [
    ]
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i681 in xrange(_size677):
            _elem682 = iprot.readString().decode('utf-8')
            self.pulseIds.append(_elem682)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class TopologyBackpressure:
  """
  Attributes:
   - componentToBackpressure
  """

  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'componentToBackpressure', (TType.STRING,None,TType.I32,None), {
    }, ), # 1
  )

  def __init__(self, componentToBackpressure=thrift_spec[1][4],):
    if componentToBackpressure is self.thrift_spec[1][4]:
      componentToBackpressure = {
    }
    self.componentToBackpressure = componentToBackpressure
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i688 in xrange(_size684):
            ...
            self.componentToBackpressure[_key689] = _val690
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TopologyBackpressure')
    if self.componentToBackpressure is not None:
      oprot.writeFieldBegin('componentToBackpressure', TType.MAP, 1)
      oprot.writeMapBegin(TType.STRING, TType.I32, len(self.componentToBackpressure))
      for kiter691,viter692 in self.componentToBackpressure.items():
        oprot.writeString(kiter691.encode('utf-8'))
        oprot.writeI32(viter692)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def validate(self):
    if self.componentToBackpressure is None:
      raise TProtocol.TProtocolException(message='Required field componentToBackpressure is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.componentToBackpressure)
    return value
