 ...
 */
package com.tencent.jstorm.config;
...
public class ConfigUtilsTest {
  ...
  public void testValidity() {
    ...
    conf.put("qqq", org.apache.storm.utils.Utils.class);
  ...
  public void testPowerOf2Validator() {
    ...
    // List testValues = Arrays.asList(42.42, 42, 23423423423L, -33, -32, -1,
    // -0.00001, 0, -0, "Forty-two");
    //
    // boolean flag = true;
    // try {
  ...
  public void testListValidator() {
    ...
    // List xMuti = Arrays.asList(oneOfXMutilParameter1, oneOfXMutilParameter2,
  ...
  public void testTopologyWorkersIsInteger() throws SecurityException,
    ...
    // Map<Object, FieldValidator> configSchemaMap =
    // ConfigUtils.configSchemaMap();
    //
  ...
  public void testClusterMode() {
    ...
    Assert.assertEquals("local", ConfigUtils.clusterMode(conf));
    Assert.assertTrue(ConfigUtils.isLocalMode(conf));
    conf.put(Config.STORM_CLUSTER_MODE, "distributed");
    Assert.assertEquals("distributed", ConfigUtils.clusterMode(conf));
    Assert.assertFalse(ConfigUtils.isLocalMode(conf));
  }

  @Test
  public void testSamplingRate() {
    Assert.assertEquals(20, ConfigUtils.samplingRate(conf));
  }

  @Test
  public void testWorkerRoot() {
    try {
      String workerRoot = ConfigUtils.workerRoot(conf, "topology_test");
  ...
  public void testWorkerPidsRoot() {
    String pidRoot = ConfigUtils.workerPidsRoot(conf, "topology_test");
