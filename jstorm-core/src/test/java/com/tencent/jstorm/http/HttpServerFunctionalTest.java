...
/**
 * This is a base class for functional tests of the {@link HttpServer}. The
 * methods are static for other classes to import statically.
 */
public class HttpServerFunctionalTest extends Assert {
  ...
  private static final String BUILD_WEBAPPS_DIR = "target/test-classes/webapps";
   ...
   * @throws AssertionError if a condition was not met
   */
  public static HttpServer createTestServer(Map conf) throws IOException {
    prepareTestWebapp();
  ...
  protected static void prepareTestWebapp() {
    ...
    File testWebappDir = new File(webapps + File.separator + TEST);
   ...
   * @throws IOException if it could not be created
   */
  public static HttpServer createServer(String webapp, Map conf)
      throws IOException {
