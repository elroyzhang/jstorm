...
public class RASTestWordSpout extends UpdateRichSpout {
  private static final long serialVersionUID = 1L;
  private static final Logger LOG =
      LoggerFactory.getLogger(RASTestWordSpout.class);
  ...
  public RASTestWordSpout() {
    this(true);
  }

  public RASTestWordSpout(long limit) {
    this(true);
    this.limit = limit;
    LOG.info("Limit is " + limit);
  }

  public RASTestWordSpout(boolean isDistributed) {
